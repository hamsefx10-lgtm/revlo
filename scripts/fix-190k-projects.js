...
async function patch190kProjects() {
    ...
    for (const id of badTxns) {
        ...
        if (t.projectId) {
            ...
            console.log(`Successfully migrated leaked Project ${t.projectId} back to main company.`);
        }
    }

    console.log("Finished patching the 4 leaked Projects.");
}

patch190kProjects().finally(() => prisma.$disconnect());

...
import { QrCode, Smartphone, RefreshCw, LogOut, CheckCircle2, XCircle, Search, MessageSquare, Send, ArrowLeft } from 'lucide-react';
    ...
    return (
        <div className="container mx-auto p-4 md:p-6 lg:p-8 max-w-4xl space-y-6">
            <div className="flex items-center gap-4 mb-2">
                <Link href="/shop/settings" className="p-2 bg-white rounded-full text-gray-400 hover:text-blue-600 hover:bg-blue-50 transition-colors shadow-sm border border-gray-100">
                    <ArrowLeft size={20} />
                </Link>
                <div>
                    <h1 className="text-3xl font-bold tracking-tight text-gray-900 dark:text-gray-100">
                        Isku-xirka WhatsApp (WhatsApp Settings)
                    </h1>
                    <p className="text-gray-500 dark:text-gray-400">
                        Kudar nambarka WhatsApp ee shirkadda si xawilaadyaha (rasiidada) si toos ah loogu diro macaamiisha.
                    </p>
                </div>
            </div>
                        ...
                        <div className="flex flex-col items-center justify-center py-8 space-y-6 text-center">
                            ...
                            <div className="space-y-2">
                                ...
                                <p className="text-sm text-gray-500 dark:text-gray-400 max-w-md mx-auto">
                                    Hadda wixii ka dambeeya, marka aad alaab iibiso (Sale) ama aad lacag Qabato (Payment), Revlo si toos ah ayuu rasiidka iibka ugu dirayaa fariinta WhatsApp nambarkooda haddii aad diiwaangelisay.
                                </p>
                            </div>

...
const VENDORS_DATA: Vendor[] = [
    { id: '1', companyName: 'Al-Nur Wholesalers', contactPerson: 'Mohamed Nur', phone: '+252 61 555 0011', email: 'sales@alnur.so', category: 'Food & Beverages', status: 'Active', openOrders: 2 },
    { id: '2', companyName: 'SomFresh Distributors', contactPerson: 'Ayan Hersi', phone: '+252 61 222 9988', email: 'orders@somfresh.com', category: 'Fresh Produce', status: 'Active', openOrders: 1 },
    { id: '3', companyName: 'Golden Grain Co.', contactPerson: 'Yusuf Ahmed', phone: '+252 61 333 4455', email: 'info@goldengrain.so', category: 'Grains & Cereals', status: 'On Hold', openOrders: 0 },
    { id: '4', companyName: 'TechWorld Imports', contactPerson: 'Sarah Ali', phone: '+252 61 777 6655', email: 'b2b@techworld.so', category: 'Electronics', status: 'Active', openOrders: 5 },
    { id: '5', companyName: 'Red Sea Logistics', contactPerson: 'Omar Dhere', phone: '+252 61 999 0000', email: 'logistics@redsea.so', category: 'Shipping', status: 'Inactive', openOrders: 0 },
];

export default function VendorsPage() {
    const [search, setSearch] = useState('');

    const filteredData = VENDORS_DATA.filter(v =>

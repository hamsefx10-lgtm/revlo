...
export default function WorkshopJobDetails() {
  ...
  const handleAddStockItem = () => {
    ...
    setStockItems([...stockItems, { productId: p.id, name: p.name, qty: Number(stockQty), cost: p.costPrice }]);
    setStockProductId('');
    setStockQty('');
  };
               ...
               <form onSubmit={handleAddExpense} className="space-y-6">
                 ...
                 {expenseType === 'MATERIAL_STOCK' ? (
                   ...
                   <>
                     ...
                     {expenseType === 'LABOR' && (
                       <div>
                         <label className="block text-sm font-bold text-gray-700 dark:text-gray-300 mb-2 mt-4">Shaqaalaha (Employee)</label>
                         <select 
                           value={employeeId}
                     ...
                     {expenseType === 'MATERIAL_NEW' && (
                       <div>
                         <label className="block text-sm font-bold text-gray-700 dark:text-gray-300 mb-2 mt-4">Vendor / Dukaan (Optional)</label>
                         <select 
                           value={vendorId}
                           onChange={(e) => setVendorId(e.target.value)}
                           className="w-full p-3 bg-gray-50 dark:bg-gray-900 border border-gray-200 dark:border-gray-700 rounded-xl focus:ring-2 focus:ring-orange-500 focus:outline-none dark:text-white"
                         >
                           <option value="">-- Dooro Vendor-ka Laga Iibiyay --</option>
                     ...
                     <div className="pt-6 border-t border-gray-100 dark:border-gray-700 flex flex-col md:flex-row gap-3 mt-6">

// app/profile/[id]/page.tsx - User Profile Page (API Integrated, Dynamic by ID)
'use client';
  ...
  return (
    <Layout>
      <div className="flex justify-between items-center mb-8">
        <h1 className="text-4xl font-bold text-darkGray dark:text-gray-100">User Profile</h1>

...
export default function NewCustomerPage() {
    ...
    const handleSubmit = async (e: React.FormEvent) => {
        ...
        try {
            ...
            setTimeout(() => router.push('/manufacturing/customers'), 1000);

        } catch (error) {
            setToast({ message: 'Error adding customer.', type: 'error' });
        } finally {
            setLoading(false);
        }
    };
    ...
    return (
        <div className="flex flex-col gap-6 p-2 lg:p-4 min-h-screen pb-20">
            ...
            <div className="flex items-center gap-4">
                ...
                <div>
                    <h1 className="text-2xl font-black text-gray-900 dark:text-white">Add New Customer</h1>
                    <p className="text-sm font-medium text-gray-500">Register new client or partner</p>
                </div>
            </div>

        ...
        {activeTab === 'Payments' && (
          <div className="space-y-6">
            {(() => {
              ...
              // FIX: Only count DEBT_REPAID on top of advancePaid (INCOME duplicates advance)
              const totalRepaidViaDebtLocal = (project.transactions || [])
              ...
              const totalPaid = totalAdvance + totalRepaidViaDebtLocal;

...
export default function InventoryManagementPage() {
  ...
  const fetchInventoryData = async () => {
    setPageLoading(true);
    try {
      const inventoryResponse = await fetch('/api/projects/inventory/store');
      ...
      const projectMaterialsResponse = await fetch('/api/projects/inventory/projects');
  ...
  const handleRestockItem = (id: string) => {
    router.push(`/projects/inventory/store/restock/${id}`);
  };
  ...
  useEffect(() => {
    async function fetchCompanyMaterialExpensesTotal() {
      try {
        const response = await fetch('/api/projects/expenses?category=Material&projectId=null');
    ...
    <Layout>
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4 lg:gap-6 mb-6 lg:mb-8 animate-fade-in-up">
        ...
        <OverviewCard
          ...
          link="/projects/inventory/projects"
        />
        <OverviewCard
          ...
          link="/projects/inventory/expenses"
        />
      </div>

      {/* Full Page Quick Access Cards - Mobile Optimized */}
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4 lg:gap-6 mb-6 lg:mb-8 animate-fade-in-up">
        <Link href="/projects/inventory/store" className="bg-white dark:bg-gray-800 p-4 lg:p-8 rounded-xl shadow-md hover:shadow-lg transition-shadow duration-300 flex items-center space-x-4 lg:space-x-6 group">
        ...
        <Link href="/projects/inventory/projects" className="bg-white dark:bg-gray-800 p-4 lg:p-8 rounded-xl shadow-md hover:shadow-lg transition-shadow duration-300 flex items-center space-x-4 lg:space-x-6 group">
        ...
        <Link href="/projects/inventory/expenses" className="bg-white dark:bg-gray-800 p-4 lg:p-8 rounded-xl shadow-md hover:shadow-lg transition-shadow duration-300 flex items-center space-x-4 lg:space-x-6 group">
      ...
      <div className="grid grid-cols-1 gap-4 lg:gap-6 mb-6 lg:mb-8 animate-fade-in-up">
        <Link href="/projects/inventory/manufacturing" className="bg-white dark:bg-gray-800 p-4 lg:p-8 rounded-xl shadow-md hover:shadow-lg transition-shadow duration-300 flex items-center space-x-4 lg:space-x-6 group">
